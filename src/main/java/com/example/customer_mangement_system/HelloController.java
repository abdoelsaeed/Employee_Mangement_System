...
static ArraycustomerList r2=new ArraycustomerList();
...
if(r2.findcoustomerby_id(id)==-1) {
    ...
    void insert(ActionEvent event) {
        ...
        Customer r1 = new Customer();
            ...
            r2.insert(r1);
 if(r1.getPhone()==null||r1.getAccumulated_Bill_Amount()==0||r1.getContract_ID()==0||r1.getNationality()==null||r1.getCurrent_Bill_Amount()==0||r1.getName()==null)
            {tt.setText("Don`t leave any field EMPTY ");}
            else{
tt.setText("<<<<<<<<<<<<<<<<<<<<DONE>>>>>>>>>>>>>>>>>>>>");
        }}
    }
